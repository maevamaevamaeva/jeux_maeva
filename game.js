...
spawnEnemy();
 spawnEnemy2();
 intervalID = window.setInterval(spawnEnemy,getRandomArbitrary(0, 1700));
  intervalID = window.setInterval(spawnEnemy2,getRandomArbitrary(0, 1700));
  document.querySelector("button").style.visibility = "hidden";
}
...
function getRandomArbitrary(min, max) {
  ...
  // invoke an enemy
  spawnEnemy();
  intervalID = window.setInterval(spawnEnemy,getRandomArbitrary(0, 800));
  document.querySelector("button").style.visibility = "hidden";
}
